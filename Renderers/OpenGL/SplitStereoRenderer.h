...
#ifndef _OPENGL_SPLIT_STEREO_RENDERER_H_
#define _OPENGL_SPLIT_STEREO_RENDERER_H_
...
class SplitStereoRenderer : public ICanvas, public ICanvasListener {
private:
    StereoCamera* stereo;
    unsigned int width, height, depth;
public:
    SplitStereoRenderer();
    virtual ~SplitStereoRenderer();
...
#endif // #define _OPENGL_COLOR_STEREO_RENDERER_H_
